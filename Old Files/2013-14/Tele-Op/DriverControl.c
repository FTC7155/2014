...
{													 // pick up block - arm position
	...
	int threshold = 9;		// this should work both both orientations of the block (flat face or holes)--- 10 was kinda working

	while(SensorValue(blockSonar)>=threshold && joy2Btn(8)!=1){		// make sure the button is working!
		motor[leftPick]=-30;
		motor[rightPick]=-30;
	}
